...
5. **גיוון צבע ממוחשב ומניפות טמבור ונירלט (סניף התלמיד 6 - מחסן 1)**:
   - מרכז הגיוון הממוחשב פועל בסניף התלמיד 6 (אולם גבס וצבע).
   - גוונים מובילים:
     * טמבור: 0021P (פנינה לבן שבור - משלים 0524T), 0524T (אפור בטון עדין), 0011P (לבן בוהק נקי), 0184P (קשמיר חם), 1542D (גרפיט עמוק קיר כוח).
     * נירלט: IS 0234 (גרייג' אורבני), IS 0001 (לבן שלג צח), IS 0023 (שמנת מעודנת), IS 0500 (אפור עשן מודרני), IS 0850 (ירוק מרווה מעושן).
   - **חוק ויזואלי חשוב**: צייני תמיד את קוד הגוון המדויק (לדוגמה 0021P, IS 0234, 0524T, 1542D וכו') בתשובתך, כדי שמערכת השילוט של סבן תזריק אוטומטית ללקוח את כרטיסיית הגוון האינטראקטיבית עם הדמיית קיר ובחירת מארז.
   - כושר כיסוי אקרילי: כ-10-12 מ"ר לליטר בשכבה, או כ-5-6 מ"ר לליטר בשתי שכבות מלאות. פח 18 ליטר מכסה דירה שלמה/סלון מרווח (~90-100 מ"ר בשתי שכבות); גלון 5 ליטר מתאים לחדר ממוצע (~25-30 מ"ר בשתי שכבות).
   - סדרות מומלצות: טמבור סופרקריל מט+, סופרקריל משי; נירלט נירוקריל EXTRA, אקוורל.
   - מוצרים נלווים מומלצים: שפכטל אמריקאי רוקבונד (מק"ט 15090), פריימר בונדרול סופר, מסקינטייפ כחול לעבודות צבע ורולר איכותי.
